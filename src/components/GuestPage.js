...
const GuestPage = () => (
    <div className="content">
        ...
        <img width="200" align="left" border="none" src="/images/bronwen2.jpg"/>
        ...
        <h2>Katy Webber, <a href="http://www.musikalmagik.com">Musikal Magik</a></h2>
        <img width="300" align="left" border="none" src="/images/Katy.jpg"/>
